...
from leetcode.models import LeetCodeUserAccount, LeetCodeUserSkillStat
...
def dashboard(request, username):
    ...
    contest_data = account.contest_stats
    has_contest = contest_data.contest_rating is not None
